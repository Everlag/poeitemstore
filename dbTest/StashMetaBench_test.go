...
// BenchmarkCompactAddStashesNoStringHeapFast determines how fast
// adding a single response to the database is with an uninitialized StringHeap.
func BenchmarkCompactAddStashesNoStringHeapFast(b *testing.B) {
